...
| --- | --- | --- |
| SSH CA + MFA + restricciones de service accounts | `reports/*sshd*`, PAM configs, audit logs | NIST 800-53 AC/IA, PCI DSS Req 7/8, SOC2 CC6/CC7, HIPAA 164.312(a)(b)(c) |
...
| Evidencias recopiladas | `reports/` artefactos | Soporte a auditoría (no certifica) |
